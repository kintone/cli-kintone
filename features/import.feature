...
Feature: cli-kintone import command
  ...
  Scenario: CliKintoneTest-28 Should return the error message when importing records with API Token, which has view permission only
  ...
  Scenario: CliKintoneTest-29 Should return the error message when updating records with API Token, which has add permission only
