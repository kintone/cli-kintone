...
const fileRecords: KintoneRecord[] = require("./fixtures/file_input.json");
const fileWithoutAttachmentsDirRecords: KintoneRecord[] = require("./fixtures/file_without_attachments_dir.json");
...
const subtableWithoutAttachmentsDirRecords: KintoneRecord[] = require("./fixtures/subtable_input_without_attachments_dir.json");
const subtableWithEmptyTable: KintoneRecord[] = require("./fixtures/subtable_input_with_empty_table.json");
