...
- `permissions` and `allowed_hosts` are sent only when the manifest has them. Leaving them out keeps the current settings on the app, and an empty array clears them.
