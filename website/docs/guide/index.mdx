...
cli-kintone (Pronounced `/ˈkuː.ri ˈkiːn.toʊn/`, named after the Japanese sweet [栗きんとん](https://visitgifu.com/see-do/kurikinton/)) is the CLI tool for importing and exporting [Kintone](https://www.kintone.com/en-us/) records. It is suitable for batch record operations.
